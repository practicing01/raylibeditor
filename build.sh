...
cc -o raylibeditor  obj/raylibeditor.o obj/splash.o obj/menu.o obj/gameplay.o obj/drawgui.o -s -Wall -std=c99 -I/opt/raylib/src -L/opt/raylib/release/libs/linux -lraylib -lGL -lm -lpthread -ldl -lrt -lX11
./raylibeditor
